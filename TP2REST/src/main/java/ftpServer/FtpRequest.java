...
public class FtpRequest extends Thread {
	...
	/**
	 * This method delete a file send by the client in the current directory.
	 * 
	 * @param fileName
	 */
	private void processDELE(String fileName) {
		File fichier = new File(repertoire.getPath() + "/" + fileName);
		if(fichier.delete())
			send(ReturnCode.serviceOk());
		else
